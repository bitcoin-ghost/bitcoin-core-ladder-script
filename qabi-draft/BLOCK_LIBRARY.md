...
Ladder Script defines 63 block types across 10 families. Each block type has a
...
| 0x0006 | QABI | no | yes | 1 | SCHEME(1) | Quantum Atomic Batch Input — PQ-only signature anchor |
