...
Defines the complete type system for Ladder Script: 63 block types across 10 families,
...
- 63 individual block evaluators (EvalSigBlock, EvalMultisigBlock, etc.)
...
2. **No new opcodes, no stack machine**: 63 typed blocks replace opcodes entirely.
