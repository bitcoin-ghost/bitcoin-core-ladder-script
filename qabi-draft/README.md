...
63 declarative function blocks, 11 typed fields, and Merkelised conditions (MLSC).
...
|----------|-------------|
| [BIP-XXXX.md](BIP-XXXX.md) | Full BIP specification (63 block types, wire format, sighash, evaluation) |
...
| [BLOCK_LIBRARY.md](BLOCK_LIBRARY.md) | Complete table of all 63 block types with fields and properties |
...
| File | Lines | Purpose |
|------|-------|---------|
| `src/rung/types.h` | 1,428 | 63 block types, 11 data types, implicit layouts, micro-header table |
| `src/rung/evaluator.cpp` | 4,217 | All 63 block evaluators, EvalBlock dispatch, VerifyRungTx |
